...
import com.dndassistant.ui.CharacterCreationDialog.CharacterCreationDialogListener
...
//        val levelList = List(20) { "Level ${it + 1}" }
        ...
        val classList = listOf(getString(R.string.class_Scientist), getString(R.string.class_Soldier), getString(R.string.class_Cleric),
        ...
        classDropdown.setOnItemClickListener { parent, _, position, _ ->
            ...
            val subclassAdapter = ArrayAdapter(activity, android.R.layout.simple_list_item_1, subclassList)
