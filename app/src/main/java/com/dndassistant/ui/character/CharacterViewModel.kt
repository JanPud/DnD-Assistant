...
class CharacterViewModel : ViewModel() {
    ...
    data class Character_Class(val Ch_class: String, val Ch_subclass: String, val experience: Int, val Ch_level: Int, val proficiency: Int)
    ...
    val skills = mutableListOf<String>(
        "Acrobatics", "Alchemy", "Athletics", "Cautious", "Encyclopedia", "History", "Hand-Eye Coordination", "Sleight of Hand", "Medicine", "Nature", "Science", "Strong Head",
        "Pain threshold", "Perception", "Performance", "Persuasion", "Underworld", "Rhetoric", "Willpower", "Strategy", "Technology", "Stealth", "Investigation", "Insight", "Intimidation"
    )
